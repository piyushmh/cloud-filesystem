...
namespace CloudStorage
{
	...
	public class UserFile	{
		...
		{
			try {
				return string.Format ("[UserFile: filepath={0}, owner={1}, filesize={3}, " +
					"sharedwithclients={4}, versionNumber={5}]", filemetadata.filepath, filemetadata.owner, filemetadata.filesize, filemetadata.sharedwithclients, filemetadata.versionNumber);
			} catch(Exception e) {
			//	logger.Debug(e);
				throw e;
			}
